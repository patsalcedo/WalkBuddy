...
function prefill(lant, long) {
  ...
  fetch('https://maps.googleapis.com/maps/api/geocode/json?latlng=' + lant + ',' + long + '&key=AIzaSyCh9AyGTUDBlpt90boFwHBjOISwRbBym20&language=en&result_type=street_address')
  .then(res => res.json())
  .then(json =>  {
